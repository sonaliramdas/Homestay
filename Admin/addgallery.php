          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card" style="margin-left:250px;" >
                <div class="card">
                  <div class="card-body">
                   <h3> Add Gallery Details</h3>
                   <br>
             <form action="controller/addgallery1.php" method="POST" enctype="multipart/form-data">
                    
                      <div class="form-group">
                        <label for="exampleInputUsername1">Gallery Image</label>
