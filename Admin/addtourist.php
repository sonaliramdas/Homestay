              ...
              <div class="col-md-6 grid-margin stretch-card" style="margin-left:250px;" >
                <div class="card">
                  <div class="card-body">
                   ...
                   <br>
             <form action="controller/addtourist1.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">Place addres</label>
                        <input type="text" name="desc" class="form-control" id="exampleInputEmail1">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Place Image</label>
