                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        ...
                        <?php  
                      $stmts = $admin -> ret("SELECT COUNT(*) FROM `category`");
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                        <?php  
                      $stmts = $admin -> ret("SELECT COUNT(*) FROM `package`");
                      $rowss = $stmts -> fetch(PDO::FETCH_ASSOC);
                      $orders = implode($rowss);
                    ...
                    <h6 class="text-muted font-weight-normal">Total Packages</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                        <?php  
                      $stmts = $admin -> ret("SELECT COUNT(*) FROM `booking`");
                      $rowss = $stmts -> fetch(PDO::FETCH_ASSOC);
                      $orders = implode($rowss);
