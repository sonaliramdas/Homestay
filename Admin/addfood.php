              ...
              <div class="col-md-6 grid-margin stretch-card" style="margin-left:250px;" >
                <div class="card">
                  <div class="card-body">
                   ...
                   <br>
             <form action="controller/addfood1.php" method="POST" enctype="multipart/form-data">
                    
                      <div class="form-group">
                        <label for="exampleInputUsername1">Food Name</label>
                      ...
                      <div class="form-group">
                        ...
                        <select name="desc" id="" class="form-control" >
                              ...
                              <?php $stmt=$admin->ret("SELECT * FROM `foodcategory`");
                              while($row=$stmt->fetch(PDO::FETCH_ASSOC))
                              {
                                ?>
                              

                              <option value="<?php echo $row['fcid']; ?>"> <?php echo $row['fcname']." - ".$row['fctype'];  ?> </option>
